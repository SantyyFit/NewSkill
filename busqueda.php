    ...
    if (isset($_POST["busuarios"])) {
        ...
        while ($row = mysql_fetch_array($consulta)) {
            ...
            <div class="usuario-card">
                <img src="<?= $fotoPerfilUsuario ?>" alt="Foto de perfil" class="perfil-img" onclick="expandirImagen(this.src)">
...
function cerrarModal(e) {
    // Cierra si se hace clic fuera de la imagen o en la X
